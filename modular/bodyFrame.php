...
if (basename($_SERVER["PHP_SELF"]) == "index.php") {
    ...
    $lastIcon .= "<paper-icon-button icon=\"icons:home\" class=\"click\" data-href=\"$protocol://$shortUrl\" data-toggle=\"tooltip\" title=\"Home\" data-placement=\"bottom\"></paper-icon-button>";
}
    ...
    <header id=\"header-bar\" class=\"fixed-bar clearfix row\">
      <div class=\"logo-container col-xs-2\">
        <div class=\"square-object\">
          ...
          <span class='hidden-xs'>Logged in as </span><span class=\"fill-user-fullname header-bar-user-name click\" data-href=\"$protocol://$shortUrl/admin-page.html\" ></span>
          </span>
          <paper-icon-button icon=\"icons:dashboard\" class=\"click logged-in-values hidden-xs\" data-href=\"$protocol://$shortUrl/admin-page.html\" data-toggle=\"tooltip\" title=\"Administration Dashboard\" data-placement=\"bottom\" hidden> </paper-icon-button>
          <paper-icon-button icon='icons:settings-applications' class=\"click logged-in-values hidden-xs\" data-href=\"$protocol://$shortUrl/admin\" data-toggle=\"tooltip\" title=\"Account Settings\" data-placement=\"bottom\" hidden></paper-icon-button>
          <paper-icon-button icon='icons:info-outline' class=\"click visible-xs\" data-href=\"$protocol://$shortUrl/about\" data-toggle=\"tooltip\" title=\"About\" data-placement=\"bottom\"></paper-icon-button>
